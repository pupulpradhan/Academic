...
class CurveDrawer {
	constructor()
	{
		...
		// [TO-DO] This is a good place to get the locations of attributes and uniform variables.  # Done
		...
		// [TO-DO] This is where you can create and set the contents of the vertex buffer object  # Done
	...
	{
		// [TO-DO] This is where we should set the transformation matrix.  # Done
		...
		// [TO-DO] Do not forget to bind the program before you set a uniform variable value.  # Done
	...
	updatePoints( pt )
	{
		// [TO-DO] The control points have changed, we must update corresponding uniform variables.  # Done
	...
	draw()
	{
		// [TO-DO] This is where we give the command to draw the curve.  # Done
		// [TO-DO] Do not forget to bind the program and set the vertex attribute.  # Done
...
var curvesVS = `
	...
	void main()
	{
		// [TO-DO] Replace the following with the proper vertex shader code  # Done
