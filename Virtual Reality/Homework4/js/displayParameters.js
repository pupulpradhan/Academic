...
var DisplayParameters = function () {
	...
	// screen width in [mm]
	this.screenWidth = 132.5;

	// screen height in [mm]
	this.screenHeight = 74.5;

	// lens diameter in [mm]
	this.lensDiameter = 34;
	...
	this.pixelPitch = this.screenWidth / 1920; // 1920: external monitor resolution in [pixels]
	...
	function computeLensMagnification() {
		...
		var magnification = _this.focalLength / (_this.focalLength - _this.distLensScreen);
	...
	function computeDistanceScreenViewer() {
		...
		/* TODO (2.1.1) Calculating Parameters of the Magnified Virtual Screen Image */
		var lensVirtualScreenDistance = Math.abs(1.0 / ((1.0/_this.focalLength) - (1.0/_this.distLensScreen)));
		var screenViewerDistance = lensVirtualScreenDistance + _this.eyeRelief;

		return screenViewerDistance;
